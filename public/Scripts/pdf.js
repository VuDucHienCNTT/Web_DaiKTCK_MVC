...
(function (a) {
    a.createModal = function (b) {
        ...
        html = '<div class="modal fade" data-backdrop="false" id="myModal">';
        ...
        if (b.closeButton === true) { html += '<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">Close</button>' } html += "</div>";
        html += "</div>"; html += "</div>"; html += "</div>"; a("body").prepend(html);
