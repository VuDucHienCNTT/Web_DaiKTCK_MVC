        ...
        public ActionResult Index(string tukhoa,int? page)
        {
            using (Web_KTCKEntities db = new Web_KTCKEntities())
            {
                ...
                if(!String.IsNullOrEmpty(tukhoa))
                {
                    ...
                    var lstResult = db.THONGBAOs.Where(n => n.TieuDe.Contains(tukhoa) || n.NoiDung.Contains(tukhoa)).OrderByDescending(n => n.NgayDang).ToPagedList(pageNumber, itemPageSize);
                ...
                else
                {
                    ...
                    var dsthongbao = db.THONGBAOs.OrderByDescending(n => n.NgayDang).ToPagedList(pageNumber, itemPageSize);
